...
export const Buster: React.FC<{ size?: number; message?: string | null; mood?: string; className?: string }> = ({ size = 120, message = null, mood = 'neutral', className = '' }) => {
    const colors = {
        body: '#E8DFC8',
        eyes: '#0A0703',
        mouth: '#0A0703',
    ...
    return (
        <div className={`buster-container ${className}`} style={{ width: size }}>
            ...
            >
                ...
                />
                {/* Face */}
                {(moodFace as any)[mood] || moodFace.neutral}
            ...
            {message && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        borderBottom: '8px solid #6B6055', // ash
                    }} />
                    {message}
                </div>
            )}
