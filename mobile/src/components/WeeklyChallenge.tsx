...
const s = StyleSheet.create({
    ...
    eyebrow: { fontFamily: fonts.sub, fontSize: 9, letterSpacing: 2, color: colors.sepia },
    weekNum: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 1, color: colors.fog },
    ...
    acceptText: { fontFamily: fonts.sub, fontSize: 10, letterSpacing: 2, color: colors.sepia },
});
