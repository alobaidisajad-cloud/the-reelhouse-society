...
const s = StyleSheet.create({
    ...
    sectionTitle: { fontFamily: fonts.sub, fontSize: 10, letterSpacing: 3, color: colors.sepia, includeFontPadding: false },
    toggleText: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 1, color: colors.fog, includeFontPadding: false },
    toggleActive: { color: colors.sepia },
    row: {
        flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
        paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: 'rgba(184,137,26,0.1)',
    },
    rowLeft: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    countryCode: { fontFamily: fonts.sub, fontSize: 11, letterSpacing: 1, color: colors.sepia, minWidth: 28, includeFontPadding: false },
    certBadge: { backgroundColor: 'rgba(184,137,26,0.3)', paddingHorizontal: 4, paddingVertical: 1, borderRadius: 2 },
    certText: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 1, color: colors.sepia, includeFontPadding: false },
    typeText: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 1, color: colors.fog, includeFontPadding: false },
    ...
    showMoreText: { fontFamily: fonts.sub, fontSize: 9, letterSpacing: 1, color: colors.fog, includeFontPadding: false },
});
