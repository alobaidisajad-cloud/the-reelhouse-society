...
const s = StyleSheet.create({
  ...
  ctaRewatch: { backgroundColor: 'transparent', borderWidth: 1, borderColor: 'rgba(184,137,26,0.3)', borderRadius: 2, paddingVertical: 12, alignItems: 'center' },
  ...
  ctaArchivist: { flex: 1, backgroundColor: 'rgba(184,137,26,0.1)', borderWidth: 1, borderColor: 'rgba(184,137,26,0.3)', borderRadius: 2, paddingVertical: 12, alignItems: 'center' },
