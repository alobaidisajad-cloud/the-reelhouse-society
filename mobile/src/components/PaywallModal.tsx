...
const s = StyleSheet.create({
    ...
    eyebrow: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 4, color: colors.sepia, textAlign: 'center', marginBottom: 8, opacity: 0.7 },
    ...
    recommendedBadge: { fontFamily: fonts.sub, fontSize: 8, letterSpacing: 2, color: colors.ink, backgroundColor: colors.sepia, alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 2, marginBottom: 8 },
    tierName: { fontFamily: fonts.display, fontSize: 20, color: colors.parchment, marginBottom: 4 },
    tierPrice: { fontFamily: fonts.sub, fontSize: 12, color: colors.sepia, letterSpacing: 1, marginBottom: 12 },
    ...
    subscribeBtnText: { fontFamily: fonts.sub, fontSize: 11, letterSpacing: 2, color: colors.ink },
});
