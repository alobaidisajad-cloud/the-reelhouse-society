...
export const st = StyleSheet.create({
  ...
  modalTitle: { fontFamily: fonts.uiMedium, fontSize: 11, letterSpacing: 2, color: colors.bloodReel },
  modalDesc: { fontFamily: fonts.body, fontSize: 13, color: colors.bone, lineHeight: 20, marginBottom: 24 },
  otpInput: { backgroundColor: colors.ink, borderWidth: 1, borderColor: '#30261A', color: colors.parchment, fontFamily: fonts.mono, fontSize: 24, padding: 16, borderRadius: 4, textAlign: 'center', marginBottom: 32, letterSpacing: 8 },
  modalActions: { flexDirection: 'row', gap: 12 },
  modalBtnCancel: { flex: 1, paddingVertical: 14, backgroundColor: 'rgba(139,105,20,0.05)', borderRadius: 4, alignItems: 'center' },
  modalBtnCancelText: { fontFamily: fonts.ui, fontSize: 10, letterSpacing: 2, color: colors.fog },
  modalBtnConfirm: { flex: 1, paddingVertical: 14, backgroundColor: colors.bloodReel, borderRadius: 4, alignItems: 'center' },
  modalBtnConfirmText: { fontFamily: fonts.uiMedium, fontSize: 10, letterSpacing: 2, color: colors.bone },
});
